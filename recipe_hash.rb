...
def amount_of_chocolate_chips(perfect_10_ingredients)
  "3/4 cup"
end
...
def ingredients_and_amounts(perfect_10_ingredients)
  puts perfect_10_ingredients.each 
end

#4: Now use `puts` to print out just the ingredients without the amounts. You'll want to use the `each_key` method.
def ingredients(perfect_10_i)
